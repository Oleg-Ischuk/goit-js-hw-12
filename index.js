import{a as b,S as v,i as n}from"./assets/vendor-tnUJPedx.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(t){if(t.ep)return;t.ep=!0;const o=s(t);fetch(t.href,o)}})();const L="https://pixabay.com/api/",S="48226781-c314bf294542f2e13595e23de";async function C(e,r=1,s=40){const a=new URLSearchParams({key:S,q:e,image_type:"photo",orientation:"horizontal",safesearch:"true",page:r,per_page:s});try{return(await b.get(`${L}?${a}`)).data}catch(t){throw console.error("Error fetching images:",t),t}}let u;function q(e){const r=document.querySelector(".gallery"),s=document.querySelector(".loader"),a=e.map(({largeImageURL:t,webformatURL:o,tags:i,likes:p,views:h,comments:y,downloads:w})=>`
